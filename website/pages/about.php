...
<h2 id="principles" class="fw-light mt-5 mb-5">Design principles</h2>
...
<p>Content should be supplied in XML, a format that is <a target="_blank" href="http://www.pmoran.ie/posts/guide-to-xml/">very easy to learn</a>. 
	...
	You do <i>not</i> need to study the vast TEI guidelines, however. You can just use the XML templates and short documentation 
	provided here (to follow).
</p>
...
<p>The core of this resource is the XML data underlying each edition. XML is an excellent format
	for long-term archiving. This data will be deposited and made publicly accessible in long-term data repositories 
	(GitHub and Zenodo) to ensure access for future generations.
</p>

<p>The technology running the website (HTML, CSS and some 
	very light PHP scripts) is also chosen to be as simple as possible, 
...
<p>Editors deserve full and clear recognition for their work. 
	...
	This will include a unique <a target="_blank" href="https://www.doi.org/" target="_blank">DOI</a> as well as
...
<p>Armarium will have an editorial board to review submissions and ensure the overall quality of the collection.
